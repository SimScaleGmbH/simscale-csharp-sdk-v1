...
public class DimensionalField
{
    ...
    [JsonPropertyName("dimensionalProfiles")]
    public DimensionalProfilesObjectDimension? DimensionalProfiles { get; set; }

    /// <summary>Possible values are: `Double` for dimensional scalar and `Vector` for dimensional vector.</summary>
    [JsonPropertyName("quantityClass")]
