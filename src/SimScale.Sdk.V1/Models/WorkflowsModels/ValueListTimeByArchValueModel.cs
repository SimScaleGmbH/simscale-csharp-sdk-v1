...
[JsonConverter(typeof(ValueListTimeByArchValueModelConverter))]
public interface ValueListTimeByArchValueModel { }

internal class ValueListTimeByArchValueModelConverter : JsonConverter<ValueListTimeByArchValueModel>
{
    ...
    public override ValueListTimeByArchValueModel? Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
    {
        ...
        return ((ValueListTimeByArchValueModel?)JsonSerializer.Deserialize(root.GetRawText(), variantType, options))
            ?? throw new JsonException("Deserialization returned null");
    }

    public override void Write(Utf8JsonWriter writer, ValueListTimeByArchValueModel value, JsonSerializerOptions options)
    {
