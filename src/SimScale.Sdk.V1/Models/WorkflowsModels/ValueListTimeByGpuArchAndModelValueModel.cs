...
[JsonConverter(typeof(ValueListTimeByGpuArchAndModelValueModelConverter))]
public interface ValueListTimeByGpuArchAndModelValueModel { }

internal class ValueListTimeByGpuArchAndModelValueModelConverter : JsonConverter<ValueListTimeByGpuArchAndModelValueModel>
{
    ...
    public override ValueListTimeByGpuArchAndModelValueModel? Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
    {
        ...
        return ((ValueListTimeByGpuArchAndModelValueModel?)JsonSerializer.Deserialize(root.GetRawText(), variantType, options))
            ?? throw new JsonException("Deserialization returned null");
    }

    public override void Write(Utf8JsonWriter writer, ValueListTimeByGpuArchAndModelValueModel value, JsonSerializerOptions options)
    {
