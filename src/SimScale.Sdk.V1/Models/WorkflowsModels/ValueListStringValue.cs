...
[JsonConverter(typeof(ValueListStringValueConverter))]
public interface ValueListStringValue { }

internal class ValueListStringValueConverter : JsonConverter<ValueListStringValue>
{
    ...
    public override ValueListStringValue? Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
    {
        ...
        return ((ValueListStringValue?)JsonSerializer.Deserialize(root.GetRawText(), variantType, options))
            ?? throw new JsonException("Deserialization returned null");
    }

    public override void Write(Utf8JsonWriter writer, ValueListStringValue value, JsonSerializerOptions options)
    {
