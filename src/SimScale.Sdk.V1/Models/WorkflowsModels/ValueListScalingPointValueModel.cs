...
[JsonConverter(typeof(ValueListScalingPointValueModelConverter))]
public interface ValueListScalingPointValueModel { }

internal class ValueListScalingPointValueModelConverter : JsonConverter<ValueListScalingPointValueModel>
{
    ...
    public override ValueListScalingPointValueModel? Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
    {
        ...
        return ((ValueListScalingPointValueModel?)JsonSerializer.Deserialize(root.GetRawText(), variantType, options))
            ?? throw new JsonException("Deserialization returned null");
    }

    public override void Write(Utf8JsonWriter writer, ValueListScalingPointValueModel value, JsonSerializerOptions options)
    {
