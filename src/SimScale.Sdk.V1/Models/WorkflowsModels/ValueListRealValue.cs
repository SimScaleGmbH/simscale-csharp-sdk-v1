...
[JsonConverter(typeof(ValueListRealValueConverter))]
public interface ValueListRealValue { }

internal class ValueListRealValueConverter : JsonConverter<ValueListRealValue>
{
    ...
    public override ValueListRealValue? Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
    {
        ...
        return ((ValueListRealValue?)JsonSerializer.Deserialize(root.GetRawText(), variantType, options))
            ?? throw new JsonException("Deserialization returned null");
    }

    public override void Write(Utf8JsonWriter writer, ValueListRealValue value, JsonSerializerOptions options)
    {
