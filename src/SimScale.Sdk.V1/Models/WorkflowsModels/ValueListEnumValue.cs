...
[JsonConverter(typeof(ValueListEnumValueConverter))]
public interface ValueListEnumValue { }

internal class ValueListEnumValueConverter : JsonConverter<ValueListEnumValue>
{
    ...
    public override ValueListEnumValue? Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
    {
        ...
        return ((ValueListEnumValue?)JsonSerializer.Deserialize(root.GetRawText(), variantType, options))
            ?? throw new JsonException("Deserialization returned null");
    }

    public override void Write(Utf8JsonWriter writer, ValueListEnumValue value, JsonSerializerOptions options)
    {
