...
public class NestedSchemaField
{
    ...
    [JsonPropertyName("nestedDataTypeReference")]
    public string? NestedDataTypeReference { get; set; }

    [JsonPropertyName("nestedSchemaDataModelClassName")]
    public string? NestedSchemaDataModelClassName { get; set; }

    [JsonPropertyName("nestedSchemaPackage")]
    public string? NestedSchemaPackage { get; set; }

    [JsonPropertyName("nestedSchemaValueModelClassName")]
    public string? NestedSchemaValueModelClassName { get; set; }
