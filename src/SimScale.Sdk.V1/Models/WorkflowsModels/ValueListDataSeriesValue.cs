...
[JsonConverter(typeof(ValueListDataSeriesValueConverter))]
public interface ValueListDataSeriesValue { }

internal class ValueListDataSeriesValueConverter : JsonConverter<ValueListDataSeriesValue>
{
    ...
    public override ValueListDataSeriesValue? Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
    {
        ...
        return ((ValueListDataSeriesValue?)JsonSerializer.Deserialize(root.GetRawText(), variantType, options))
            ?? throw new JsonException("Deserialization returned null");
    }

    public override void Write(Utf8JsonWriter writer, ValueListDataSeriesValue value, JsonSerializerOptions options)
    {
