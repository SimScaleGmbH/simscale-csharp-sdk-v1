...
public class InlineOperationDefinition : AtomicOperationDefinition
{
    ...
    [JsonPropertyName("outputDataValueModels")]
    public Dictionary<string, Value>? OutputDataValueModels { get; set; }
