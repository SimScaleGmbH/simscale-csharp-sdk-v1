...
/// <summary>Abstract workflow operation definition. It can be either: * atomic method or nested workflow, * composition element: grouping operations, control structures etc.</summary>
public class AbstractOperationDefinition
{
