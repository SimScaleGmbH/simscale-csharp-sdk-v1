...
[JsonConverter(typeof(ValueListValueConverter))]
public interface ValueListValue { }

internal class ValueListValueConverter : JsonConverter<ValueListValue>
{
    ...
    public override ValueListValue? Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
    {
        ...
        return ((ValueListValue?)JsonSerializer.Deserialize(root.GetRawText(), variantType, options))
            ?? throw new JsonException("Deserialization returned null");
    }

    public override void Write(Utf8JsonWriter writer, ValueListValue value, JsonSerializerOptions options)
    {
