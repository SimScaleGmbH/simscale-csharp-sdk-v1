...
public class SimulationRunResultSolution : OneOfSimulationRunResult
{
    [JsonPropertyName("type")]
    public string Type { get; set; } = "SOLUTION_FIELD";
    ...
    /// <summary>URL for opening the solution fields in the Workbench.</summary>
