...
[JsonConverter(typeof(OneOf_ElasticityMarcPoissonsRatioConverter))]
public interface OneOf_ElasticityMarcPoissonsRatio { }

internal class OneOf_ElasticityMarcPoissonsRatioConverter : JsonConverter<OneOf_ElasticityMarcPoissonsRatio>
{
    ...
    public override OneOf_ElasticityMarcPoissonsRatio? Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
    {
        ...
        return ((OneOf_ElasticityMarcPoissonsRatio?)JsonSerializer.Deserialize(root.GetRawText(), variantType, options))
            ?? throw new JsonException("Deserialization returned null");
    }

    public override void Write(Utf8JsonWriter writer, OneOf_ElasticityMarcPoissonsRatio value, JsonSerializerOptions options)
    {
