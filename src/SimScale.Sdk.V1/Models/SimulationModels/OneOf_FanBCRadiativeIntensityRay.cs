...
[JsonConverter(typeof(OneOf_FanBCRadiativeIntensityRayConverter))]
public interface OneOf_FanBCRadiativeIntensityRay { }

internal class OneOf_FanBCRadiativeIntensityRayConverter : JsonConverter<OneOf_FanBCRadiativeIntensityRay>
{
    ...
    public override OneOf_FanBCRadiativeIntensityRay? Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
    {
        ...
        return ((OneOf_FanBCRadiativeIntensityRay?)JsonSerializer.Deserialize(root.GetRawText(), variantType, options))
            ?? throw new JsonException("Deserialization returned null");
    }

    public override void Write(Utf8JsonWriter writer, OneOf_FanBCRadiativeIntensityRay value, JsonSerializerOptions options)
    {
