...
public class ErrorRetimingEvent : OneOf_AutoTimestepDefinitionRetimingEvent
{
    ...
    public OneOf_ErrorRetimingEventTimestepCalculationType? TimestepCalculationType { get; set; }
