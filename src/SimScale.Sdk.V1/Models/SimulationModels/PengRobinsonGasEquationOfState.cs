...
public class PengRobinsonGasEquationOfState : OneOf_HConstThermoEquationOfState
{
    ...
    public string Type { get; set; } = "PENG_ROBINSON_GAS";

    [JsonPropertyName("criticalTemperature")]
    public Dimensional_Temperature? CriticalTemperature { get; set; }

    [JsonPropertyName("criticalVolume")]
    public Dimensional_MolarMass? CriticalVolume { get; set; }

    [JsonPropertyName("criticalPressure")]
    public Dimensional_Pressure? CriticalPressure { get; set; }

    /// <summary>Specify the acentric factor. It is a property of the material that characterized the changes in thermodynamic propert...</summary>
    [JsonPropertyName("acentricFactor")]
