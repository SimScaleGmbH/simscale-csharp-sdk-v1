...
public class OpenBoundaryRayBC : OneOf_PressureOutletBCRadiativeIntensityRay, OneOf_WallBCRadiativeIntensityRay, OneOf_FanBCRadiativeIntensityRay, OneOf_PressureInletBCRadiativeIntensityRay, OneOf_VelocityOutletBCRadiativeIntensityRay, OneOf_VelocityInletBCRadiativeIntensityRay
{
    ...
    public string Type { get; set; } = "OPEN_BOUNDARY_RAY";
