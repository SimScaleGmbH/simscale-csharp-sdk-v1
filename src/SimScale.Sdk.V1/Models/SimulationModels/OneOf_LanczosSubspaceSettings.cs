...
[JsonConverter(typeof(OneOf_LanczosSubspaceSettingsConverter))]
public interface OneOf_LanczosSubspaceSettings { }

internal class OneOf_LanczosSubspaceSettingsConverter : JsonConverter<OneOf_LanczosSubspaceSettings>
{
    ...
    public override OneOf_LanczosSubspaceSettings? Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
    {
        ...
        return ((OneOf_LanczosSubspaceSettings?)JsonSerializer.Deserialize(root.GetRawText(), variantType, options))
            ?? throw new JsonException("Deserialization returned null");
    }

    public override void Write(Utf8JsonWriter writer, OneOf_LanczosSubspaceSettings value, JsonSerializerOptions options)
    {
