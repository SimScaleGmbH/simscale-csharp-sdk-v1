...
public class UserDefinedWriteControl : OneOf_SolidSimulationControlWriteControlDefinition
{
    ...
    public string Type { get; set; } = "USER_DEFINED_V21";

    [JsonPropertyName("writeIncrement")]
    public RestrictedDimensionalFunction_Time? WriteIncrement { get; set; }
