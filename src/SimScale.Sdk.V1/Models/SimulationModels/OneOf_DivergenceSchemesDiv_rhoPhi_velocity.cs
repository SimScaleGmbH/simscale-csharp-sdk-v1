...
[JsonConverter(typeof(OneOf_DivergenceSchemesDiv_rhoPhi_velocityConverter))]
public interface OneOf_DivergenceSchemesDiv_rhoPhi_velocity { }

internal class OneOf_DivergenceSchemesDiv_rhoPhi_velocityConverter : JsonConverter<OneOf_DivergenceSchemesDiv_rhoPhi_velocity>
{
    ...
    public override OneOf_DivergenceSchemesDiv_rhoPhi_velocity? Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
    {
        ...
        return ((OneOf_DivergenceSchemesDiv_rhoPhi_velocity?)JsonSerializer.Deserialize(root.GetRawText(), variantType, options))
            ?? throw new JsonException("Deserialization returned null");
    }

    public override void Write(Utf8JsonWriter writer, OneOf_DivergenceSchemesDiv_rhoPhi_velocity value, JsonSerializerOptions options)
    {
