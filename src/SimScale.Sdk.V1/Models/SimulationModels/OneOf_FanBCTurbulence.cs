...
[JsonConverter(typeof(OneOf_FanBCTurbulenceConverter))]
public interface OneOf_FanBCTurbulence { }

internal class OneOf_FanBCTurbulenceConverter : JsonConverter<OneOf_FanBCTurbulence>
{
    ...
    public override OneOf_FanBCTurbulence? Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
    {
        ...
        return ((OneOf_FanBCTurbulence?)JsonSerializer.Deserialize(root.GetRawText(), variantType, options))
            ?? throw new JsonException("Deserialization returned null");
    }

    public override void Write(Utf8JsonWriter writer, OneOf_FanBCTurbulence value, JsonSerializerOptions options)
    {
