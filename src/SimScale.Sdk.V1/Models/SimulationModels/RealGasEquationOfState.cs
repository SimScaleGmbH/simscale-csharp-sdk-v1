...
public class RealGasEquationOfState : OneOf_HConstThermoEquationOfState
{
    ...
    public string Type { get; set; } = "REAL_GAS";

    [JsonPropertyName("density")]
    public DimensionalFunction_Density? Density { get; set; }

    [JsonPropertyName("specificEnthalpy")]
    public DimensionalFunction_SpecificEnergy? SpecificEnthalpy { get; set; }
