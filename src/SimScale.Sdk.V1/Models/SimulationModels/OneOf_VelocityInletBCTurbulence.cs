...
[JsonConverter(typeof(OneOf_VelocityInletBCTurbulenceConverter))]
public interface OneOf_VelocityInletBCTurbulence { }

internal class OneOf_VelocityInletBCTurbulenceConverter : JsonConverter<OneOf_VelocityInletBCTurbulence>
{
    ...
    public override OneOf_VelocityInletBCTurbulence? Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
    {
        ...
        return ((OneOf_VelocityInletBCTurbulence?)JsonSerializer.Deserialize(root.GetRawText(), variantType, options))
            ?? throw new JsonException("Deserialization returned null");
    }

    public override void Write(Utf8JsonWriter writer, OneOf_VelocityInletBCTurbulence value, JsonSerializerOptions options)
    {
