...
public class FieldChangeRetimingEvent : OneOf_AutoTimestepDefinitionRetimingEvent
{
    ...
    public string Type { get; set; } = "FIELD_CHANGE";

    [JsonPropertyName("fieldSelection")]
    public OneOf_FieldChangeRetimingEventFieldSelection? FieldSelection { get; set; }

    /// <summary>This value defines the maximum allowed change of the defined target field component within each time increment. If th...</summary>
    [JsonPropertyName("thresholdValue")]
    public double? ThresholdValue { get; set; }

    [JsonPropertyName("timestepCalculationType")]
    public OneOf_FieldChangeRetimingEventTimestepCalculationType? TimestepCalculationType { get; set; }
