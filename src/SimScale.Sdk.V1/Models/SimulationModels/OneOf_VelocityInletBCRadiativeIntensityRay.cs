...
[JsonConverter(typeof(OneOf_VelocityInletBCRadiativeIntensityRayConverter))]
public interface OneOf_VelocityInletBCRadiativeIntensityRay { }

internal class OneOf_VelocityInletBCRadiativeIntensityRayConverter : JsonConverter<OneOf_VelocityInletBCRadiativeIntensityRay>
{
    ...
    public override OneOf_VelocityInletBCRadiativeIntensityRay? Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
    {
        ...
        return ((OneOf_VelocityInletBCRadiativeIntensityRay?)JsonSerializer.Deserialize(root.GetRawText(), variantType, options))
            ?? throw new JsonException("Deserialization returned null");
    }

    public override void Write(Utf8JsonWriter writer, OneOf_VelocityInletBCRadiativeIntensityRay value, JsonSerializerOptions options)
    {
