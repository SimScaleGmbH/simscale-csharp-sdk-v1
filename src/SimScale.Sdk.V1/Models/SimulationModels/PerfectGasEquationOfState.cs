...
public class PerfectGasEquationOfState : OneOf_HConstThermoEquationOfState, OneOf_FluidCompressibleMaterialEquationOfState
{
    ...
    public string Type { get; set; } = "PERFECT_GAS";
