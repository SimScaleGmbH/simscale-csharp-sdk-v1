...
public class PerfectFluidEquationOfState : OneOf_HConstThermoEquationOfState
{
    ...
    public string Type { get; set; } = "PERFECT_FLUID";

    [JsonPropertyName("fluidConstant")]
    public Dimensional_SpecificHeat? FluidConstant { get; set; }
