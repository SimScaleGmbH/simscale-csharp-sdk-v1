...
public class PacefishFinenessVeryCoarse : OneOf_PacefishAutomeshNewFineness, OneOf_RegionRefinementWindComfortNewFineness, OneOf_SurfaceRefinementWindComfortNewFineness, OneOf_WindComfortMeshWindComfortFineness
{
    ...
    public string Type { get; set; } = "VERY_COARSE";
