...
public class ContactConductanceLayer : OneOf_AdvancedConceptsThermalContactResistance
{
    ...
    public string Type { get; set; } = "CONTACT_CONDUCTANCE_LAYER";

    [JsonPropertyName("name")]
    public string? Name { get; set; }

    [JsonPropertyName("interfaceThermal")]
    public OneOf_ContactConductanceLayerInterfaceThermal? InterfaceThermal { get; set; }
