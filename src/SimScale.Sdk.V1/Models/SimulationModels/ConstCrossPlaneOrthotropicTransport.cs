...
public class ConstCrossPlaneOrthotropicTransport : OneOf_SolidCompressibleMaterialTransport
{
    ...
    public string Type { get; set; } = "CONST_CROSS_PLANE_ORTHO";

    [JsonPropertyName("conductivity")]
    public CrossPlaneOrthotropicConductivity? Conductivity { get; set; }

    [JsonPropertyName("orientation")]
    public OneOf_ConstCrossPlaneOrthotropicTransportOrientation? Orientation { get; set; }
