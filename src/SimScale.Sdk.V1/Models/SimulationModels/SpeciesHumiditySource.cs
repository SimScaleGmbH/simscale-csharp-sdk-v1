...
public class SpeciesHumiditySource : OneOf_AdvancedConceptsHumiditySources
{
    ...
    public string Type { get; set; } = "SPECIES_MASS_FLOW_RATE";

    [JsonPropertyName("name")]
    public string? Name { get; set; }

    [JsonPropertyName("waterVaporMassRate")]
    public Dimensional_MassFlowRate? WaterVaporMassRate { get; set; }

    [JsonPropertyName("dryAirMassRate")]
    public Dimensional_MassFlowRate? DryAirMassRate { get; set; }
