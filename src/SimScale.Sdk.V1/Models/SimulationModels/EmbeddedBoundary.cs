...
public class EmbeddedBoundary : Analysis
{
    /// <summary>Schema name: EmbeddedBoundary</summary>
    [JsonPropertyName("type")]
    public string Type { get; set; } = "EMBEDDED_BOUNDARY";

    /// <summary>This toggle allows you to create an additional external fluid domain via a Cartesian box. Enable this toggle if you w...</summary>
    [JsonPropertyName("allowExternalFlow")]
    ...
    [JsonPropertyName("externalFlowBoundaryCondition")]
    public OneOf_EmbeddedBoundaryExternalFlowBoundaryCondition? ExternalFlowBoundaryCondition { get; set; }

    [JsonPropertyName("boundaryConditions")]
    public List<OneOf_EmbeddedBoundaryBoundaryConditions>? BoundaryConditions { get; set; }
    ...
    [JsonPropertyName("embeddedBoundaryMeshing")]
    ...
    public OneOf_EmbeddedBoundaryTimeDependency? TimeDependency { get; set; }
