...
[JsonConverter(typeof(OneOf_StaticAnalysisBoundaryConditionsConverter))]
public interface OneOf_StaticAnalysisBoundaryConditions { }

internal class OneOf_StaticAnalysisBoundaryConditionsConverter : JsonConverter<OneOf_StaticAnalysisBoundaryConditions>
{
    ...
    public override OneOf_StaticAnalysisBoundaryConditions? Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
    {
        ...
        return ((OneOf_StaticAnalysisBoundaryConditions?)JsonSerializer.Deserialize(root.GetRawText(), variantType, options))
            ?? throw new JsonException("Deserialization returned null");
    }

    public override void Write(Utf8JsonWriter writer, OneOf_StaticAnalysisBoundaryConditions value, JsonSerializerOptions options)
    {
