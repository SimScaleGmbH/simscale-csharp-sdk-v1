...
[JsonConverter(typeof(OneOf_VelocityOutletBCRadiativeIntensityRayConverter))]
public interface OneOf_VelocityOutletBCRadiativeIntensityRay { }

internal class OneOf_VelocityOutletBCRadiativeIntensityRayConverter : JsonConverter<OneOf_VelocityOutletBCRadiativeIntensityRay>
{
    ...
    public override OneOf_VelocityOutletBCRadiativeIntensityRay? Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
    {
        ...
        return ((OneOf_VelocityOutletBCRadiativeIntensityRay?)JsonSerializer.Deserialize(root.GetRawText(), variantType, options))
            ?? throw new JsonException("Deserialization returned null");
    }

    public override void Write(Utf8JsonWriter writer, OneOf_VelocityOutletBCRadiativeIntensityRay value, JsonSerializerOptions options)
    {
