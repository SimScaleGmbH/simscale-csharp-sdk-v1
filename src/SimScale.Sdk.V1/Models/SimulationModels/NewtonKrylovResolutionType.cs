...
public class NewtonKrylovResolutionType : OneOf_SolidNumericsMechanicalResolutionType, OneOf_SolidNumericsThermalResolutionType
{
    ...
    public string Type { get; set; } = "NEWTON_KRYLOV";

    [JsonPropertyName("convergenceCriteria")]
    public OneOf_NewtonKrylovResolutionTypeConvergenceCriteria? ConvergenceCriteria { get; set; }
    ...
    public OneOf_NewtonKrylovResolutionTypeJacobianMatrix? JacobianMatrix { get; set; }
