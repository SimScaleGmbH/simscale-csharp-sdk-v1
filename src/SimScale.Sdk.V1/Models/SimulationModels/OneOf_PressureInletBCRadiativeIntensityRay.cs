...
[JsonConverter(typeof(OneOf_PressureInletBCRadiativeIntensityRayConverter))]
public interface OneOf_PressureInletBCRadiativeIntensityRay { }

internal class OneOf_PressureInletBCRadiativeIntensityRayConverter : JsonConverter<OneOf_PressureInletBCRadiativeIntensityRay>
{
    ...
    public override OneOf_PressureInletBCRadiativeIntensityRay? Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
    {
        ...
        return ((OneOf_PressureInletBCRadiativeIntensityRay?)JsonSerializer.Deserialize(root.GetRawText(), variantType, options))
            ?? throw new JsonException("Deserialization returned null");
    }

    public override void Write(Utf8JsonWriter writer, OneOf_PressureInletBCRadiativeIntensityRay value, JsonSerializerOptions options)
    {
