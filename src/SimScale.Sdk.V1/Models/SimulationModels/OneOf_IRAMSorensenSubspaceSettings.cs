...
[JsonConverter(typeof(OneOf_IRAMSorensenSubspaceSettingsConverter))]
public interface OneOf_IRAMSorensenSubspaceSettings { }

internal class OneOf_IRAMSorensenSubspaceSettingsConverter : JsonConverter<OneOf_IRAMSorensenSubspaceSettings>
{
    ...
    public override OneOf_IRAMSorensenSubspaceSettings? Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
    {
        ...
        return ((OneOf_IRAMSorensenSubspaceSettings?)JsonSerializer.Deserialize(root.GetRawText(), variantType, options))
            ?? throw new JsonException("Deserialization returned null");
    }

    public override void Write(Utf8JsonWriter writer, OneOf_IRAMSorensenSubspaceSettings value, JsonSerializerOptions options)
    {
