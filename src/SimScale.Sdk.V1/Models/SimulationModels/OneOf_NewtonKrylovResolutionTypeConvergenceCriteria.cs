...
[JsonConverter(typeof(OneOf_NewtonKrylovResolutionTypeConvergenceCriteriaConverter))]
public interface OneOf_NewtonKrylovResolutionTypeConvergenceCriteria { }

internal class OneOf_NewtonKrylovResolutionTypeConvergenceCriteriaConverter : JsonConverter<OneOf_NewtonKrylovResolutionTypeConvergenceCriteria>
{
    ...
    public override OneOf_NewtonKrylovResolutionTypeConvergenceCriteria? Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
    {
        ...
        return ((OneOf_NewtonKrylovResolutionTypeConvergenceCriteria?)JsonSerializer.Deserialize(root.GetRawText(), variantType, options))
            ?? throw new JsonException("Deserialization returned null");
    }

    public override void Write(Utf8JsonWriter writer, OneOf_NewtonKrylovResolutionTypeConvergenceCriteria value, JsonSerializerOptions options)
    {
