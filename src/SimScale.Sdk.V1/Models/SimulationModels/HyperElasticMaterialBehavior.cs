...
public class HyperElasticMaterialBehavior : OneOf_SolidMaterialMaterialBehavior
{
    ...
    public string Type { get; set; } = "HYPER_ELASTIC";

    [JsonPropertyName("hyperElasticModel")]
    public OneOf_HyperElasticMaterialBehaviorHyperElasticModel? HyperElasticModel { get; set; }
