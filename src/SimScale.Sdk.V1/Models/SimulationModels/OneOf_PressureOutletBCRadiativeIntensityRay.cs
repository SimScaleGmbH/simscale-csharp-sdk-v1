...
[JsonConverter(typeof(OneOf_PressureOutletBCRadiativeIntensityRayConverter))]
public interface OneOf_PressureOutletBCRadiativeIntensityRay { }

internal class OneOf_PressureOutletBCRadiativeIntensityRayConverter : JsonConverter<OneOf_PressureOutletBCRadiativeIntensityRay>
{
    ...
    public override OneOf_PressureOutletBCRadiativeIntensityRay? Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
    {
        ...
        return ((OneOf_PressureOutletBCRadiativeIntensityRay?)JsonSerializer.Deserialize(root.GetRawText(), variantType, options))
            ?? throw new JsonException("Deserialization returned null");
    }

    public override void Write(Utf8JsonWriter writer, OneOf_PressureOutletBCRadiativeIntensityRay value, JsonSerializerOptions options)
    {
