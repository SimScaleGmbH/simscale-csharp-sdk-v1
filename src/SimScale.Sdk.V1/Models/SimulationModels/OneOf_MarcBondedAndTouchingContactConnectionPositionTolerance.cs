...
[JsonConverter(typeof(OneOf_MarcBondedAndTouchingContactConnectionPositionToleranceConverter))]
public interface OneOf_MarcBondedAndTouchingContactConnectionPositionTolerance { }

internal class OneOf_MarcBondedAndTouchingContactConnectionPositionToleranceConverter : JsonConverter<OneOf_MarcBondedAndTouchingContactConnectionPositionTolerance>
{
    ...
    public override OneOf_MarcBondedAndTouchingContactConnectionPositionTolerance? Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
    {
        ...
        return ((OneOf_MarcBondedAndTouchingContactConnectionPositionTolerance?)JsonSerializer.Deserialize(root.GetRawText(), variantType, options))
            ?? throw new JsonException("Deserialization returned null");
    }

    public override void Write(Utf8JsonWriter writer, OneOf_MarcBondedAndTouchingContactConnectionPositionTolerance value, JsonSerializerOptions options)
    {
